...
namespace Core.Modules.AuthModule.DTOs
{
    public class RegisterRequestDto
    {
        ...
        [RegularExpression(@"^[\p{L}\p{M}\s]+$", 
            ErrorMessage = "The {0} field must not contain special characters, only letters and spaces are allowed.")]
        ...
        [RegularExpression(
            ...
            ErrorMessage = "The {0} must be 8-16 characters long and include at least one uppercase letter, one lowercase letter, and one digit.")]
